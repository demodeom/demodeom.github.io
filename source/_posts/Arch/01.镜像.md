...
Server = https://mirrors.aliyun.com/archlinux/$repo/os/$arch' | sudo tee /etc/pacman.d/mirrorlist > /dev/null
```

> 备注： 国内镜像很多，添加 **清华大学镜像**、**阿里云镜像**  两个镜像即可
...
Server = http://mirror.yuri.so/arch/$repo/os/$arch
...
Server = http://mirrors.twilight.fyi/archlinux/$repo/os/$arch
Server = https://mirrors.twilight.fyi/archlinux/$repo/os/$arch
